        ...
        {activeTab === 'profile' ? (
          <form onSubmit={handleSaveProfile} className="profile-form">
            ...
            <div className="form-group" style={{ textAlign: 'center', marginBottom: '1.5rem' }}>
              <label style={{ marginBottom: '0.5rem', display: 'block', fontWeight: 'bold' }}>Profile Avatar</label>
              ...
              <div style={{ marginBottom: '1rem', display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '1rem' }}>
                <div style={{ position: 'relative', width: '100px', height: '100px' }}>
                  {profile.profilePic ? (
                    <img src={profile.profilePic} alt="Current Profile" style={{ width: '100%', height: '100%', borderRadius: '50%', objectFit: 'cover', border: '3px solid #3b82f6' }} />
                  ) : (
                    <div style={{ width: '100%', height: '100%', borderRadius: '50%', background: '#e2e8f0', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '2.5rem', color: '#64748b' }}>
                ...
                <span style={{ fontSize: '0.9rem', color: '#64748b' }}>Click pencil to upload your photo</span>
              </div>

              <div style={{ borderTop: '1px solid #e2e8f0', margin: '1rem 0' }}></div>
              <label style={{ marginBottom: '0.5rem', display: 'block', fontSize: '0.9rem', color: '#64748b' }}>Or Choose an Avatar</label>
                  ...
                  'https://api.dicebear.com/7.x/avataaars/svg?seed=Ivan'].map((u, i) => (
                    <img
                      ...
                      style={{
                        ...
                        border: profile.profilePic === u ? '2px solid #3b82f6' : '2px solid transparent',
                        cursor: 'pointer', opacity: profile.profilePic === u ? 1 : 0.6,
                        transition: 'all 0.2s'
                      }}
