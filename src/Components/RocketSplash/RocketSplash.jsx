...
import { FaBook, FaPen, FaLaptop, FaGraduationCap, FaFlask, FaMicroscope, FaAtom, FaBrain, FaLightbulb, FaChalkboardTeacher, FaUserGraduate, FaBookOpen, FaPencilAlt, FaStickyNote, FaClipboard } from 'react-icons/fa';
import { GiNotebook, GiBookshelf, GiStackOfBooks, GiBookCover, GiOpenBook, GiReading, GiTeacher, GiAcademicCap } from 'react-icons/gi';
import { MdSchool, MdMenuBook, MdEdit, MdScience, MdPsychology, MdBiotech, MdComputer, MdLibraryBooks } from 'react-icons/md';
