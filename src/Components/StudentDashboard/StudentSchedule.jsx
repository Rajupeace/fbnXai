    ...
    const getTodaySchedule = () => {
        ...
        return schedule
            .filter(item => {
                ...
                // If enrolledSubjects is empty (initial load or error), show all for safety or fallback
                if (!enrolledSubjects || enrolledSubjects.length === 0) return true;

                // Sync Fix: Only show classes for subjects the student is currently enrolled in
